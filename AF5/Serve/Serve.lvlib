...
<Library LVVersion="24008000">
	...
	<Item Name="操作者消息" Type="Folder">
		<Item Name="GetMsg消息.lvclass" Type="LVClass" URL="../Serve Messages/GetMsg消息/GetMsg消息.lvclass"/>
		<Item Name="SendMsg消息.lvclass" Type="LVClass" URL="../Serve Messages/SendMsg消息/SendMsg消息.lvclass"/>
	</Item>
	<Item Name="Serve.lvclass" Type="LVClass" URL="../Serve/Serve.lvclass"/>
</Library>
